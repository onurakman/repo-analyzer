...
pub struct Cli {
    ...
    /// Run only these reports (comma-separated: health,authors,hotspots,churn,ownership,coupling,patterns,age,bloat,outliers,quality,complexity,composition,construct_churn,debt_markers,large_sources,half_life,succession,knowledge_silos,fan_in_out,module_coupling,churn_pareto,construct_ownership,commit_velocity,test_ratio)
    #[arg(long)]
